...
$sql2 = "UPDATE ads SET weight=$weight WHERE meetID='$meetID'";
	$result2 = mysql_query($sql2);
		$sql4 = "UPDATE users SET coins=$userCoins WHERE email='$email'";
	$result4 = mysql_query($sql4);
	echo "<script type='text/javascript'>window.top.location='userMeets.php';</script>"; exit;
	}else{
		
	echo "<script type='text/javascript'>window.top.location='userMeets.php?error=coins';</script>"; exit;

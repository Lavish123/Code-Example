	...
	if($_GET['error'] == "notActivated"){
		...
		$error = "The email you have entered has not been activated yet, Please check your junk mail.";
...
<script>
  ...
  ga('send', 'pageview');
   ...
   ================================================== -->
   <meta charset="utf-8">
	<title>Login | SupercarVibe</title>
	   	...
	   	<nav id="main-nav-wrap">
				<ul class="main-navigation">
					...
					<li><a class="highlight with-sep"  href="create.php" title="">Create Meet</a></li>
										<li class="current"><a class="highlight with-sep"  href="login.php" title="">Login</a></li>
...
<br>
	      		<div class="subscribe-form">
	      			<form action="loginProc.php" class="loginForm" method="POST" class="group" novalidate="true">
<center>
			   			...
			   			<button class="button button-primary full-width" type="submit" name="submit">Login</button>
		   	</center>
	      	...
	      	<?php
			if($_GET['error'] == "notActivated"){
				echo'<button class="button button-primary full-width" type="submit" onclick="resend()" name="submit">Resend Email</button>';
					
				}
			?>
<script>
function resend(){
	var lol = document.getElementById('email').value;
	window.location.href = "http://supercarvibe.com/resend.php?email="+lol;
}

...
$query = "SELECT * FROM orders WHERE orderCode='$id'";
	...
	$currCoins = $row2['coins'];
	$coins = $row['amount'] + $currCoins;
	
	$sql3 = "UPDATE users SET coins='$coins' WHERE id='$userID'";
	$result3 = mysql_query($sql3);
	
	$sql4 = "DELETE FROM orders WHERE orderCode='$id'";
